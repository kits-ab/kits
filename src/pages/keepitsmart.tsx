import {
  ...
  interface AiPageProps extends PageProps {
    data: {
  ...
  export default ({ data, location }: AiPageProps) => {
        ...
        {projects.map((project) => {
          ...
          return (
            <Media
              ...
              key={`ai_project_${project.node.frontmatter.index}`}
              src={image && image.src}
  ...
  export const pageQuery = graphql`
    query AiPageQuery {
      page: allMarkdownRemark(filter: { frontmatter: { type: { eq: "AiPage" } } }) {
        edges {
          node {
            frontmatter {
              title
      ...
      projects: allMarkdownRemark(
        filter: { frontmatter: { type: { eq: "ai_project" } } }
